...
export default class FrontPage extends React.Component {
  ...
  resetState = (imageList, checkBoxesHidden) => {
    this.setState({
      imageList: imageList,
      selectedImageCount: 0,
      imageOrderNumber: 0,
  ...
  onSubmit = () => {
    saveSelectedImages(helpers.getRequestPayloadForImageSave(
      ...
      this.resetState(selectedImages.images, true);
    });
  }
        ...
        <div>
          <div>
            <Form className="formProperties">
              <h3>Select Images From the Grid. Maximum of {maximumImageCountOnGrid} images can be selected</h3>
